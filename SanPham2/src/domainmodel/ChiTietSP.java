...
public class ChiTietSP {
    ...
    public ChiTietSP(String id, String idSP, String idSize, String idMauSac, String idDongSP, String idAnh, String maDanhMuc, Integer thoiGianBH, Double gia, Integer trangThai) {
        this.id = id;
        this.idSP = idSP;
        this.idSize = idSize;
        this.idMauSac = idMauSac;
